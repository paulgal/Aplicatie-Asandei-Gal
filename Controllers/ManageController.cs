...
namespace Interface.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private ServiceCaller<SettingsModel> _settingsServiceCaller;
        public ServiceCaller<SettingsModel> SettingsServiceCaller
        {
            get
            {
                return _settingsServiceCaller ?? (_settingsServiceCaller = new ServiceCaller<SettingsModel>());
            }
            set
            {
                _settingsServiceCaller = value;
            }
        }
        ...
        //Get: /Manage/ChangeActivitySettings
        public ActionResult ChangeActivitySettings()
        {
            return View();
        }
        ...
        public ActionResult ChangeUserAccountSettings()
        {
            return View();
        }
        ...
        public ActionResult ChangeUserAccountSettings(ChangeUserAccountSettingsViewModel model)
        {
            ...
            if (!String.IsNullOrEmpty(model.FullName)) account.FullName = model.FullName;
            if (!String.IsNullOrEmpty(model.PhoneNumber)) account.PhoneNumber = model.PhoneNumber;
